    ...
    try {
        ...
        const Matrix = makeWASocket({
            ...
            getMessage: async (key) => {
                ...
                return { conversation: "Pritam-V1 Nonstop Testing" };
            }
        });
        ...
        Matrix.ev.on('connection.update', (update) => {
            ...
            if (connection === 'close') {
                ...
                if (initialConnection) {
                    console.log(chalk.green("Deployment Successful️ ✅"));
                    Matrix.sendMessage(Matrix.user.id, { text: `Deployment Successful️ ✅` });
